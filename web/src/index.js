...
(function() {
        ...
        this.moveUp = function(){
            ...
            if(inBoundary(target)){
                ...
                if(inWorld(target)){
                    ...
                    bounds = {
                        min: {x: bounds.min.x, y: bounds.min.y -8},
                        max: {x: bounds.max.x, y: bounds.max.y - 8}
                    };
                    this.y = bounds.max.y;    
                }
            }                   
        ...
        this.moveLeft = function(){
            ...
            if(inBoundary(target)){                
                ...
                if(inWorld(target)){
                     ...
                     bounds = {
                        min: {x: bounds.min.x - 8, y: bounds.min.y},
                        max: {x: bounds.max.x - 8, y: bounds.max.y}
                    };
                    this.x = bounds.max.x;    
                }
    ...
    var cells = [
        ...
        {x: 13, y: 4, terrain: "sand", traversable:true},
        {x: 14, y: 4, terrain: "sand", traversable:true},
        ...
        {x: 11, y: 5, terrain: "sand", traversable:true},
        {x: 12, y: 5, terrain: "grass", traversable:true},
        {x: 13, y: 5, terrain: "sand", traversable:true},
        {x: 14, y: 5, terrain: "sand", traversable:true},
        {x: 15, y: 5, terrain: "sand", traversable:true},
        ...
        {x: 12, y: 6, terrain: "sand", traversable:true},
        {x: 13, y: 6, terrain: "sand", traversable:true},
        {x: 14, y: 6, terrain: "sand", traversable:true},
        {x: 15, y: 6, terrain: "sand", traversable:true},
        {x: 8, y: 7, terrain: "sand", traversable:true},
        {x: 9, y: 7, terrain: "sand", traversable:true},
        {x: 10, y: 7, terrain: "sand", traversable:true},
        {x: 11, y: 7, terrain: "sand", traversable:true},
        {x: 12, y: 7, terrain: "sand", traversable:true},
        {x: 13, y: 7, terrain: "sand", traversable:true},
        {x: 14, y: 7, terrain: "sand", traversable:true},
        {x: 15, y: 7, terrain: "sand", traversable:true},

        {x: 0, y: 8, terrain: "sand", traversable:true},
        {x: 1, y: 8, terrain: "sand", traversable:true},
        {x: 2, y: 8, terrain: "sand", traversable:true},
        {x: 3, y: 8, terrain: "sand", traversable:true},
        {x: 4, y: 8, terrain: "sand", traversable:true},
        {x: 5, y: 8, terrain: "sand", traversable: true},
        {x: 6, y: 8, terrain: "sand", traversable:true},
        ...
        {x: 3, y: 9, terrain: "sand", traversable:true},
        {x: 4, y: 9, terrain: "sand", traversable: true},
        {x: 5, y: 9, terrain: "sand", traversable: true},
        {x: 6, y: 9, terrain: "sand", traversable: true},
        {x: 7, y: 9, terrain: "sand", traversable:true},
        {x: 0, y: 10, terrain: "sand", traversable:true},
        {x: 1, y: 10, terrain: "sand", traversable:true},
        {x: 2, y: 10, terrain: "sand", traversable:true},
        {x: 3, y: 10, terrain: "sand", traversable:true},
        {x: 4, y: 10, terrain: "sand", traversable:true},
        {x: 5, y: 10, terrain: "sand", traversable:true},
        {x: 6, y: 10, terrain: "sand", traversable:true},
        {x: 7, y: 10, terrain: "sand", traversable:true},
        {x: 0, y: 11, terrain: "sand", traversable:true},
        {x: 1, y: 11, terrain: "sand", traversable:true},
        {x: 2, y: 11, terrain: "sand", traversable:true},
        {x: 3, y: 11, terrain: "sand", traversable:true},
        {x: 4, y: 11, terrain: "sand", traversable:true},
        {x: 5, y: 11, terrain: "sand", traversable:true},
        {x: 6, y: 11, terrain: "sand", traversable:true},
        {x: 7, y: 11, terrain: "sand", traversable:true},
        {x: 0, y: 12, terrain: "sand", traversable:true},
        {x: 1, y: 12, terrain: "sand", traversable:true},
        {x: 2, y: 12, terrain: "sand", traversable:true},
        {x: 3, y: 12, terrain: "sand", traversable:true},
        {x: 4, y: 12, terrain: "sand", traversable:true},
        {x: 5, y: 12, terrain: "sand", traversable:true},
        {x: 6, y: 12, terrain: "sand", traversable:true},
        {x: 7, y: 12, terrain: "sand", traversable:true},
        {x: 0, y: 13, terrain: "sand", traversable:false},
        {x: 1, y: 13, terrain: "sand", traversable:true},
        {x: 2, y: 13, terrain: "sand", traversable:true},
        {x: 3, y: 13, terrain: "sand", traversable:true},
        {x: 4, y: 13, terrain: "sand", traversable:true},
        {x: 5, y: 13, terrain: "sand", traversable:true},
        {x: 6, y: 13, terrain: "sand", traversable:true},
        ...
        {x: 2, y: 14, terrain: "sand", traversable:true},
        {x: 3, y: 14, terrain: "sand", traversable:true},
        {x: 4, y: 14, terrain: "sand", traversable:true},
        {x: 5, y: 14, terrain: "sand", traversable:true},
        {x: 6, y: 14, terrain: "sand", traversable:true},
        {x: 7, y: 14, terrain: "sand", traversable:true},
        {x: 0, y: 15, terrain: "sand", traversable:true},
        {x: 1, y: 15, terrain: "sand", traversable:true},
        {x: 2, y: 15, terrain: "sand", traversable:true},
        {x: 3, y: 15, terrain: "sand", traversable:true},
        {x: 4, y: 15, terrain: "sand", traversable:true},
        {x: 5, y: 15, terrain: "sand", traversable:true},
        {x: 6, y: 15, terrain: "sand", traversable:true},
        ...
        {x: 8, y: 11, terrain: "grass", traversable:true},
        ...
        {x: 13, y: 11, terrain: "grass", traversable:true},
        {x: 14, y: 11, terrain: "grass", traversable:true},
        {x: 15, y: 11, terrain: "grass", traversable:true},
        {x: 8, y: 12, terrain: "grass", traversable:true},
        {x: 9, y: 12, terrain: "grass", traversable:true},
        {x: 10, y: 12, terrain: "water", traversable:false},
        {x: 11, y: 12, terrain: "grass", traversable:true},
        {x: 12, y: 12, terrain: "water", traversable:false},
        {x: 13, y: 12, terrain: "water", traversable:false},
        {x: 14, y: 12, terrain: "quicksand", traversable:true},
        {x: 15, y: 12, terrain: "grass", traversable:true},
        {x: 8, y: 13, terrain: "sand", traversable:true},
        {x: 9, y: 13, terrain: "water", traversable:false},
        {x: 10, y: 13, terrain: "water", traversable:false},
        {x: 11, y: 13, terrain: "sand", traversable:true},
        {x: 12, y: 13, terrain: "grass", traversable:true},
        {x: 13, y: 13, terrain: "water", traversable:false},
        {x: 14, y: 13, terrain: "water", traversable:false},
        {x: 15, y: 13, terrain: "water", traversable:false},
        {x: 8, y: 14, terrain: "water", traversable:false},
        {x: 9, y: 14, terrain: "water", traversable:false},
        {x: 10, y: 14, terrain: "water", traversable:false},
        {x: 11, y: 14, terrain: "water", traversable:false},
        {x: 12, y: 14, terrain: "water", traversable:false},
        {x: 13, y: 14, terrain: "grass", traversable:true},
        {x: 14, y: 14, terrain: "grass", traversable:true},
        {x: 15, y: 14, terrain: "grass", traversable:true},
        {x: 8, y: 15, terrain: "grass", traversable:true},
        ...
        {x: 13, y: 15, terrain: "grass", traversable:true},
        {x: 14, y: 15, terrain: "grass", traversable:true},
    ...
    function coordToIndex(x, y){
        ...
        var idx = (8 * (y - bounds.min.y)) + (x - bounds.min.x) + 1;
        return idx
    }
